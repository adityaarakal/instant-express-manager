/**
 * PDF Export Functions (Lazy Loaded)
 * 
 * This module is separated from transactionExport.ts to enable lazy loading.
 * jspdf and jspdf-autotable are only loaded when PDF export is actually used.
 */
